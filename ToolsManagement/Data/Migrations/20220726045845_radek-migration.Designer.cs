...
namespace ToolsManagement.Migrations
{
    ...
    [Migration("20220726045845_radek-migration")]
    partial class radekmigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToolsManagement.Models.CreateDrillDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CreateDrillDto");
                });

            modelBuilder.Entity("ToolsManagement.Models.CreateDrillParametersDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("CreateDrillDtoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CreateDrillDtoId");

                    b.ToTable("CreateDrillParametersDto");
                });
            ...
            modelBuilder.Entity("ToolsManagement.Models.CreateDrillParametersDto", b =>
                {
                    b.HasOne("ToolsManagement.Models.CreateDrillDto", null)
                        .WithMany("DrillParameters")
                        .HasForeignKey("CreateDrillDtoId");
                });
